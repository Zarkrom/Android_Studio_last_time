...
public class Profil implements Serializable {
    ...
    private static final float denutrition = 16.5f;
    ...
    private int choix; // 0 pour IMC et 1 pour poids ideal
    private float poids;
    private float taille;
    private int sexe; // 0 pour femme et 1 pour homme
    private float resultatIMC;
    private String message;

    public Profil(int choix, float poids, float taille, int sexe) {
        this.choix = choix;
        this.poids = poids;
        this.taille = taille;
        this.sexe = sexe;
